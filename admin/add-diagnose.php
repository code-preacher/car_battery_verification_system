                                     ...
                                     <div class="row p-t-20">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label">
                                                        <input type="checkbox" class="" name="f1" value="1" >Sign1: </label>
                                                     </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label">
                                                        <input type="checkbox" class="" name="f2" value="1" >Sign2: </label>
                                                     </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label">
                                                        <input type="checkbox" class="" name="f3" value="1" >Sign3: </label>
                                                     </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label">
                                                        <input type="checkbox" class="" name="f4" value="1" >Sign4: </label>
                                                     </div>
                                            </div>
                                             ...
                                             <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label">
                                                        <input type="checkbox" class="" name="f5" value="1" >Sign5: </label>
                                                     </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label">
                                                        <input type="checkbox" class="" name="f6" value="1" >Sign6: </label>
                                                     </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label">
                                                        <input type="checkbox" class="" name="f7" value="1" >Sign7: </label>
                                                     </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label">
                                                        <input type="checkbox" class="" name="f8" value="1" >Sign8: </label>
                                                     </div>
                                            </div>
